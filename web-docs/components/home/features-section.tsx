...
import { CatCLI } from '../magicui/cat-cli';
import ClippedCard from '../magicui/cliped-card';
    ...
    <section ref={sectionRef} className="px-4 py-24 max-w-7xl mx-auto bg-[#161616]" id='features'>
      <div ref={headerRef} className="text-center mb-20">
        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white tracking-tight">
          Potencia tu <span className="text-[#BBF451] italic font-serif drop-shadow-[0_0_25px_rgba(132,204,22,0.4)]">flujo de trabajo</span>
        </h2>
        <p className="text-gray-400 text-lg max-w-2xl mx-auto font-light leading-relaxed">
          Todo lo que necesitas para escalar tus aplicaciones full-stack desde el primer día, automatizado y estandarizado.
        </p>
      </div>
            ...
            >
              <div className="text-left w-full">
                ...
                <p className="text-black/80 text-sm mb-6 font-medium">
                  Docker, Linter, Hooks y más listos para usar.
                </p>
                <div className="mt-4">
                  <AnimatedChecklist
                    items={[
