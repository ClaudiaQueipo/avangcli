                ...
                <div className="absolute right-16 top-1/2 -translate-y-1/2 hidden xl:flex flex-col gap-4 z-10 pointer-events-none">
                    <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-2xl w-72 shadow-[0_0_40px_rgba(0,0,0,0.3)] rotate-3 hover:rotate-0 transition-transform duration-500">
                        ...
                        <div className="space-y-2 font-mono text-xs text-gray-300">
                            <div className="flex items-center gap-2 text-white"><span className="text-lime-400">📂</span> /apps</div>
                            <div className="pl-4 flex items-center gap-2 border-l border-white/10 ml-1"><span className="text-blue-400">⚛️</span> web-nextjs</div>
                            <div className="pl-4 flex items-center gap-2 border-l border-white/10 ml-1"><span className="text-yellow-400">⚡</span> api-fastapi</div>
                            <div className="pl-4 flex items-center gap-2 border-l border-white/10 ml-1"><span className="text-sky-400">🐳</span> docker-compose</div>
                        </div>
                    </div>
                ...
                <div className="relative z-10 flex flex-col items-center justify-center px-4 w-full max-w-4xl mx-auto flex-1">
                    <h1 className="text-center text-white text-5xl md:text-7xl font-bold mb-8 leading-[1.1] tracking-tight">
                        ...
                        <span className="inline-block text-lime-300 italic font-serif mt-2">
                            <FlipWords words={words} className="text-lime-300 drop-shadow-[0_0_25px_rgba(132,204,22,0.4)] flex flex-col text-center md:flex-row md:text-left" />
                        </span>
                    </h1>
...
const FloatingCard = ({ name, time, amount, icon, rotation }: FloatingCardProps) => (
    <div className={`flex items-center gap-3 bg-[#D4FC79] text-black p-3 rounded-2xl w-56 shadow-2xl border border-white/50 transform transition-transform duration-300 ${rotation}`}>
