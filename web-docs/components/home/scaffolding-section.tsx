...
import { Layout, Database, Layers, Code2, FileCode, Folder } from 'lucide-react';
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        ...
        <div ref={headerRef} className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white tracking-tight">
            Scaffolding <span className="text-[#BBF451] italic font-serif drop-shadow-[0_0_25px_rgba(132,204,22,0.4)]">Inteligente</span>
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto font-light leading-relaxed">
            Genera automáticamente la estructura completa de módulos para Next.js. 
            Mantén tu código organizado, predecible y escalable desde el primer commit.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div ref={itemsRef} className="order-1 lg:order-2 space-y-10">
            <div className="numbered-item flex gap-6 group">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2 text-white group-hover:text-lime-300 transition-colors">Estructura Modular</h3>
                <p className="text-gray-400 leading-relaxed">
                  Olvídate del "spaghetti code". Cada funcionalidad vive en su propio módulo aislado, encapsulando su lógica, UI, estado y tipos.
                </p>
              </div>
            </div>
            ...
            <div className="numbered-item flex gap-6 group">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2 text-white group-hover:text-lime-300 transition-colors">Archivos Boilerplate</h3>
                <p className="text-gray-400 leading-relaxed">
                  Se generan automáticamente los archivos base necesarios. No pierdas tiempo copiando y pegando estructuras de carpetas vacías.
                </p>
              </div>
            </div>
            ...
            <div className="numbered-item flex gap-6 group">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2 text-white group-hover:text-lime-300 transition-colors">Barrel Exports</h3>
                <p className="text-gray-400 leading-relaxed">
                  Configuración automática de <code className="text-lime-400 bg-white/5 px-1 rounded">index.ts</code> para mantener tus importaciones limpias en todo el proyecto: <span className="text-gray-500 italic">import {'{ Auth }'} from '@/modules'</span>.
                </p>
              </div>
            </div>
