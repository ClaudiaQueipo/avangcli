...
import { Check, GitBranch, Cloud, Plug, Milestone } from 'lucide-react';
      ...
      <div className="container mx-auto max-w-5xl relative z-10 px-6">
        ...
        <div ref={headerRef} className="text-center mb-24">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white tracking-tight">
            El futuro de <span className="text-[#BBF451] drop-shadow-[0_0_25px_rgba(132,204,22,0.4)] italic font-serif">AvangCLI</span>
          </h2>
        ...
        <div ref={timelineRef} className="relative">
          <div ref={lineRef} className="absolute left-6 md:left-1/2 top-0 bottom-0 w-px bg-linear-to-b from-transparent via-white/10 to-transparent md:-translate-x-1/2 z-0" />
          ...
          <div className="space-y-20">
              ...
              <div className="roadmap-content md:w-1/2 md:text-right order-2 md:order-1 pl-12 md:pl-0">
                <div className="relative bg-[#1a1a1a] border border-white/10 p-6 rounded-2xl shadow-xl overflow-hidden group-hover:border-lime-500/30 transition-all duration-500">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Generación completa de proyectos Next.js con TypeScript, Tailwind CSS configurado y estructura de carpetas optimizada.
                  </p>
                </div>
              </div>
            ...
            <div className="roadmap-item relative flex flex-col md:flex-row gap-8 items-start md:items-center group">
              ...
              <div className="timeline-dot absolute left-6 md:left-1/2 -translate-x-[7px] md:-translate-x-1/2 flex items-center justify-center z-10 order-1 md:order-2">
                 <span className="progress-glow absolute inline-flex h-full w-full rounded-full bg-yellow-400 opacity-75"></span>
              ...
              <div className="roadmap-content md:w-1/2 pl-12 md:pl-0 order-3 md:order-3 w-full">
                 <div className="relative bg-[#1a1a1a] border border-yellow-500/30 p-6 rounded-2xl shadow-[0_0_30px_-10px_rgba(234,179,8,0.1)] overflow-hidden">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Soporte nativo para backend con Python/FastAPI. Incluye autenticación JWT, configuración de CORS y conexión a base de datos.
                  </p>
                </div>
            ...
            <div className="roadmap-item relative flex flex-col md:flex-row gap-8 items-start md:items-center group">
              ...
              <div className="roadmap-content md:w-1/2 md:text-right order-2 md:order-1 pl-12 md:pl-0">
                 <div className="relative bg-[#1a1a1a] border border-white/5 p-6 rounded-2xl shadow-lg overflow-hidden group-hover:border-blue-500/30 transition-all duration-500 opacity-80 group-hover:opacity-100">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Despliegue automático a AWS, Vercel y DigitalOcean con configuración de Terraform generada automáticamente.
                  </p>
                </div>
              </div>

              <div className="timeline-dot absolute left-6 md:left-1/2 -translate-x-[7px] md:-translate-x-1/2 flex items-center justify-center z-10 order-1 md:order-2">
                 <div className="w-4 h-4 rounded-full bg-[#161616] border-2 border-white/20 group-hover:border-blue-400 transition-colors" />
              </div>

              <div className="md:w-1/2 pl-12 md:pl-12 order-3 md:order-3">
                <span className="text-sm font-mono font-bold text-gray-500 group-hover:text-blue-400 transition-colors">Q3 2024</span>
              </div>
            </div>
            ...
            <div className="roadmap-item relative flex flex-col md:flex-row gap-8 items-start md:items-center group">
              <div className="md:w-1/2 md:text-right order-2 md:order-1 hidden md:block pr-12">
                 <span className="text-sm font-mono font-bold text-gray-500 group-hover:text-purple-400 transition-colors">Q4 2024</span>
              </div>
